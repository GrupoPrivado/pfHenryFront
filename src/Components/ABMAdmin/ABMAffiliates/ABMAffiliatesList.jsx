              ...
              <div class="bg-white p-6 rounded-md">
                <div>
                  ...
                  <div className="mt-3.5">
                    <div>
                      <div class=" grid overflow-hidden grid-cols-9 grid-rows-1 gap-0 bg-gradient-to-tr from-indigo-600 to-purple-600 rounded-md py-2 px-4 text-white font-bold text-md">
        ...
        allAffiliates.map((element) => {
                          return (
                            <div key={element._id} className={styles.tabla}>
                              <div class="grid overflow-hidden grid-cols-9 grid-rows-1 gap-0 py-1 px-4 items-center border-t text-sm font-normal mt-4 space-x-4">
