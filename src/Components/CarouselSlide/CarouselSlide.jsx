        ...
        <div>
            <div className="relative w-screen">
                ...
                <div className='absolute top-52 right-52'>
                    ...
                    <h2 className='text-3xl'>Elegí el mejor plan médico</h2>
                    <Link to="/contact">
                        <button className='w-64 h-12 my-5 text-2xl font-semibold text-white rounded-md bg-secondary'>Cotizá tu PLAN ahora</button>
                    </Link>
                </div>
            </div>
        </div>
