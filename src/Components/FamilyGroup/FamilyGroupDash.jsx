  ...
  return (
    <Link to="/afiliado/group">
      <div
        ...
        className="relative flex flex-col items-center h-full p-4 bg-white justify-evenly md:col-span-1 md:row-span-1 rounded-2xl backdrop-filter backdrop-blur-lg bg-opacity-20 undefined"
      >
        ...
        exit={{ opacity: 0, y: -20 }}
        transition={{ duration: 1.5 }} className="flex flex-col justify-around px-2.5 w-full font-normal text-white shrink-0">
          {group.length ? (
            group.map((e) => (
